...
namespace NJIS.FPZWS.UI.Common.AppContainer
{
    /// <inheritdoc />
    /// <summary>
    /// 可以把其他窗体应用程序嵌入此容器
    ...
    public partial class AppContainer : Panel
    {
        private readonly EventHandler _appIdleEvent;
        public AppContainer()
        {
            InitializeComponent();
            var appIdleAction = new Action<object, EventArgs>(Application_Idle);
            _appIdleEvent = new EventHandler(appIdleAction);
        }
        ...
        public void Start()
        {
            ...
            try
            {
                var info = new ProcessStartInfo(this._mAppFilename)
                {
        ...
        public string AppFilename
        {
            get
            {
                return _mAppFilename;
            }
            set
            {
                if (value == null || value == _mAppFilename) return;
        ...
        /// 标识内嵌程序是否已经启动
        /// </summary>
        public bool IsStarted => (this.m_AppProcess != null);
