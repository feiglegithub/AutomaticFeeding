...
//   文 件 名：ProductionDataDbSetting.cs
...
{
    public class ProductionDataDbSetting : ConfigWapper<ProductionDataDbSetting>
    {
        ...
        public override string Path { get; protected set; } = "数据库连接/MSSQL/ProductionDataDbSetting";
    }
}