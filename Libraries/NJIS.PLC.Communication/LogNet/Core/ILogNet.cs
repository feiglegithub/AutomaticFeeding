...
namespace NJIS.PLC.Communication.LogNet.Core
{
    ...
    ///     <code lang="cs" source="TestProject\NJIS.PLC.CommunicationDemo\FormLogNet.cs" region="ILogNet"
    ///         title="ILogNet示例" />
    /// </example>
    public interface ILogNet : IDisposable
    {
        ...
        ///     存储之前引发的事件，允许额外的操作
        /// </summary>
        event EventHandler<NjisEventArgs> BeforeSaveToFile;
        ...
        void RecordMessage(NjisMessageDegree degree, string keyWord, string text);
        ...
        void SetMessageDegree(NjisMessageDegree degree);
