...
namespace NJIS.PLC.Communication.Profinet.Melsec
{
    ...
    /// <example>
    ///     <code lang="cs"
    ///         source="NJIS.PLC.Communication_Net45.Test\Documentation\Samples\Profinet\melsecTest.cs"
    ...
    public class MelsecMcNet : NetworkDeviceBase<MelsecQnA3EBinaryMessage, RegularByteTransform>
    {
        ...
        public override OperateResult Write(string address, byte[] value)
        {
            ...
            // 错误码校验
            var ErrorCode = BitConverter.ToUInt16(read.Content, 9);
            if (ErrorCode != 0)
        ...
        public OperateResult<bool[]> ReadBool(string address, ushort length)
        {
            ...
            if (analysis.Content1.DataType == 0x00)
                return new OperateResult<bool[]>(0, StringResources.Language.MelsecReadBitInfo);
            ...
            byte networkStationNumber = 0)
        {
            ...
            var _PLCCommand = new byte[21 + value.Length];
            _PLCCommand[0] = 0x50; // 副标题
            _PLCCommand[1] = 0x00;
            _PLCCommand[2] = networkNumber; // 网络号
            _PLCCommand[3] = 0xFF; // PLC编号
        ...
        public static OperateResult<byte[]> ExtractActualData(byte[] response, bool isBit)
        {
            ...
            {
                // 位读取
                var Content = new byte[(response.Length - 11) * 2];
            ...
            {
                // 字读取
                var Content = new byte[response.Length - 11];
