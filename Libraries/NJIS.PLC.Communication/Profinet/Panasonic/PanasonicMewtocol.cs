...
namespace NJIS.PLC.Communication.Profinet.Panasonic
{
    /// <summary>
    ...
    public class PanasonicMewtocol : SerialDeviceBase<RegularByteTransform>
    {
        ...
        public OperateResult<bool[]> ReadBool(string address, ushort length)
        {
            ...
            // 提取bool
            var buffer = SoftBasic.BytesReverseByWord(read.Content);
        ...
        {
            // 计算字节数据
            var buffer = SoftBasic.BoolArrayToByte(values);

            // 创建指令
            var command = BuildWriteCommand(Station, address, SoftBasic.BytesReverseByWord(buffer),
                (short) values.Length);
            if (!command.IsSuccess) return command;
        ...
        private static string CalculateCrc(StringBuilder sb)
        {
            ...
            return SoftBasic.ByteToHexString(new[] {tmp});
        }
        ...
        public static OperateResult<byte[]> BuildReadMultiCoil(string[] address)
        {
            ...
            var sb = new StringBuilder("%EE#RCP");
            sb.Append(address.Length.ToString());
            for (var i = 0; i < address.Length; i++)
            {
                // 解析地址
                var analysis = AnalysisAddress(address[i]);
        ...
        public static OperateResult<byte[]> BuildWriteMultiCoil(string[] address, bool[] values)
        {
            ...
            if (address == null || values == null)
                return new OperateResult<byte[]>("address and values is not allowed null");
            if (address.Length < 1 || address.Length > 8)
                return new OperateResult<byte[]>("address length must be 1-8");
            if (address.Length != values.Length)
                return new OperateResult<byte[]>("address and values length must be same");

            var sb = new StringBuilder("%EE#WCP");
            sb.Append(address.Length.ToString());
            for (var i = 0; i < address.Length; i++)
            {
                // 解析地址
        ...
        public static OperateResult<byte[]> BuildReadCommand(byte station, string address, ushort length)
        {
            ...
            if (analysis.Content1 == "X" || analysis.Content1 == "Y" || analysis.Content1 == "R" ||
                analysis.Content1 == "L")
            {
                sb.Append("RCC");
                sb.Append(analysis.Content1);
        ...
        public static OperateResult<byte[]> ExtraActualData(byte[] response)
        {
            ...
            if (response[3] == '!')
            {
                ...
                {
                    case 20:
                        msg = StringResources.Language.PanasonicMewStatus20;
                        break;
                    case 21:
                        msg = StringResources.Language.PanasonicMewStatus21;
                        break;
                    case 22:
                        msg = StringResources.Language.PanasonicMewStatus22;
                        break;
                    case 23:
                        msg = StringResources.Language.PanasonicMewStatus23;
                        break;
                    case 24:
                        msg = StringResources.Language.PanasonicMewStatus24;
                        break;
                    case 25:
                        msg = StringResources.Language.PanasonicMewStatus25;
                        break;
                    case 26:
                        msg = StringResources.Language.PanasonicMewStatus26;
                        break;
                    case 27:
                        msg = StringResources.Language.PanasonicMewStatus27;
                        break;
                    case 28:
                        msg = StringResources.Language.PanasonicMewStatus28;
                        break;
                    case 29:
                        msg = StringResources.Language.PanasonicMewStatus29;
                        break;
                    case 30:
                        msg = StringResources.Language.PanasonicMewStatus30;
                        break;
                    case 40:
                        msg = StringResources.Language.PanasonicMewStatus40;
                        break;
                    case 41:
                        msg = StringResources.Language.PanasonicMewStatus41;
                        break;
                    case 42:
                        msg = StringResources.Language.PanasonicMewStatus42;
                        break;
                    case 43:
                        msg = StringResources.Language.PanasonicMewStatus43;
                        break;
                    case 50:
                        msg = StringResources.Language.PanasonicMewStatus50;
                        break;
                    case 51:
                        msg = StringResources.Language.PanasonicMewStatus51;
                        break;
                    case 52:
                        msg = StringResources.Language.PanasonicMewStatus52;
                        break;
                    case 53:
                        msg = StringResources.Language.PanasonicMewStatus53;
                        break;
                    case 60:
                        msg = StringResources.Language.PanasonicMewStatus60;
                        break;
                    case 61:
                        msg = StringResources.Language.PanasonicMewStatus61;
                        break;
                    case 62:
                        msg = StringResources.Language.PanasonicMewStatus62;
                        break;
                    case 63:
                        msg = StringResources.Language.PanasonicMewStatus63;
                        break;
                    case 65:
                        msg = StringResources.Language.PanasonicMewStatus65;
                        break;
                    case 66:
                        msg = StringResources.Language.PanasonicMewStatus66;
                        break;
                    case 67:
                        msg = StringResources.Language.PanasonicMewStatus67;
                        break;
                    default:
