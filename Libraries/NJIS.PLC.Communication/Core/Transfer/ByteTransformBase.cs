...
namespace NJIS.PLC.Communication.Core.Transfer
{
    ...
    public class ByteTransformBase : IByteTransform
    {
        ...
        public virtual string TransString(byte[] buffer, int length, Encoding encoding)
        {
            return TransString(buffer, 0,length, encoding);
        }
