...
using ArithmeticsTest.Commands;
using ArithmeticsTest.Commands.Args;
using NJIS.FPZWS.LineControl.Cutting.Model;
using NJIS.FPZWS.UI.Common.Message;

namespace ArithmeticsTest.Services
{
    public class LocalService : ILocalService
    {
        ...
        private List<ICommand> DownCommands { get; set; } = new List<ICommand>();
        ...
        private LocalService()
        {
            ...
            devices.ForEach(device=>
            {
                ...
                DownCommands.Add(new DownLoadCommand(device));
            });
