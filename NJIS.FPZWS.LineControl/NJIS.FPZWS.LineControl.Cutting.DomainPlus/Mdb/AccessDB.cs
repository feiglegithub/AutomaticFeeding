...
namespace NJIS.FPZWS.LineControl.Cutting.DomainPlus.Mdb
{
    public class AccessDb : IDisposable
    {
        ...
        private string AccessFileName { get; }
        ...
        private List<Tuple<string, OleDbDataAdapter>> Adapters { get; } = new List<Tuple<string, OleDbDataAdapter>>();
