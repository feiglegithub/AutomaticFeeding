...
using System.IO;
using System.Linq;
using NJIS.FPZWS.LineControl.Cutting.DomainPlus.Extension;
using NJIS.FPZWS.LineControl.Cutting.DomainPlus.Model;
...
namespace NJIS.FPZWS.LineControl.Cutting.DomainPlus.Mdb
{
    internal class MdbOperator
    {
        ...
        /// <returns></returns>
        public static DataSet CombineMdbs(List<DataSet> dataSets)
        {
        ...
        /// <returns></returns>
        public static string GetTitle(DataSet data)
        {
            var title = data.Tables[HEADER].Rows[0][TITLE].ToString();
            return title;
        }
        ...
        /// <returns></returns>
        public static bool UpdatedJobName(DataSet data,string name)
        {
            data.Tables[JOBS].Rows[0][NAME] = name;
            return true;
        }
