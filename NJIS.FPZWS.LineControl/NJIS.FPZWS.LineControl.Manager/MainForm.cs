...
namespace NJIS.FPZWS.LineControl.Manager
{
    public partial class MainForm : Telerik.WinControls.UI.RadForm
    {
        ...
        public MainForm()
        {
            ...
            {
                //移除建剁，锯切图，锯切图明细，剁，垛明细，批次组，锯切图日志页面
                ...
                //radPageView1.Pages.Remove(radPageViewPage4);
                //radPageView1.Pages.Remove(radPageViewPage5);
                //radPageView1.Pages.Remove(radPageViewPage7);
                //radPageView1.Pages.Remove(radPageViewPage9);
                ...
                ////10、11到位
                //inPlaceThread = new Thread(new ThreadStart(inPlaceLoop));
                //inPlaceThread.Start();

                ////12、13推板
                //requestBoardThread = new Thread(new ThreadStart(requestBoardLoop));
                //requestBoardThread.Start();
            };
            ...
            if (listBatchGroupPlus.Count > 0)
            {
                ...
                if (batchProductionDetails.DifferenceNumber > 0)
                {
                    ...
                    List<CuttingStackList> listCuttingStackList = lineControlCuttingServicePlus.
                        GetUnRequestCuttingStackListByBatchNameAndMinStackProductIndex(batchName,CuttingStackListBatchType.AUTO);
        ...
        ////循环向PLC写入值
        //private bool loopWritePLC(string addr,int loop,string value)
        //{
        //    if (string.IsNullOrEmpty(plc.ReadString(addr,20)))
        //    {
