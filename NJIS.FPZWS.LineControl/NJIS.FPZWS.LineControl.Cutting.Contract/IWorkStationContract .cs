...
{
    [ServiceContract]
    public interface IWorkStationContract : IWcfServiceContract
    {
        /// <summary>
        /// 获取生产计划时间上的开料数据
        /// </summary>
        /// <param name="planTime">生产计划时间</param>
        /// <param name="itemNameIsNull">堆垛号是否为空</param>
        /// <returns></returns>
        [OperationContract]
        List<CuttingStackList> GetCuttingStackLists(DateTime planTime,bool itemNameIsNull);
