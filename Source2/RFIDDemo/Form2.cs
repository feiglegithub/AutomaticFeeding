...
namespace RFIDDemo
{
    public partial class Form2 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                res = Reader2002.Net_ConnectScanner(ref m_hSocket, readerip, readerport, hostip, hostport);
                if (res == 0) { break; }
            }
        ...
        {
            //Reader2002.Net_DisconnectScanner();
            Reader2002.DisconnectScanner(m_hSocket);
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            res = Reader2002.Net_SetAntenna(m_hSocket, be_antenna);
            ...
            //设置天线
            res = Reader2002.Net_SetAntenna(m_hSocket, 1);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //读EPC标签
            res = Reader2002.Net_EPC1G2_ReadLabelID(m_hSocket, mem, ptr, len, mask, IDBuffer, ref nCounter);
            if (res == OK)
            {
                //int kk = 0;
            ...
            for (int ii = 0; ii < k; ii++)
            {
                ...
                {
                    strtemp = str[jj * 2].ToString() + str[j * 2 + 1].ToString();
            ...
            if (comboBox3.Text != "")
            {
                ...
                //通过标签读取托盘号
                res = Reader2002.Net_EPC1G2_ReadWordBlock(m_hSocket, 6, IDTemp, 1, 4, 6, DB, AccessPassWord);
                if (res == OK)
                {
                    str = "";
                    for (i = 0; i < 12; i++)
                    ...
                    if (this.txtInWareName.Text == "2002")
                    {
