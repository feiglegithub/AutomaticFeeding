//===============================================================================
// SqlHelper基于微软数据访问应用程序块(DAAB)for.net
//
// SqlHelper.cs
//
// 这个文件包含实现的SqlHelper和SqlHelperParameterCache类。
//
//==============================================================================
...
{
	/// <summary>
    /// SqlHelper类用于封装高性能，可扩展的最佳实践常见的用途SqlClient的。 
	/// </summary>
	public sealed class SqlHelper
	{
        ...
        public static int ExecSQL(string sql, string SqlConnect)
        {
        ...
        public static int ExecSQL(string sql, SqlParameter[] paras, string SqlConnect)
        {
        ...
        /// <returns></returns>
        public static DataSet ExecProcDataSet(string procName, SqlParameter[] paras, string SqlConnect)
        {
            SqlConnection conn = new SqlConnection(SqlConnect);//创建数据库连接对象
        ...
        /// <returns>返回值</returns>
        public static object ProcOutput(string procName, SqlParameter[] paras, string OutName, string SqlConnect)
        {
            SqlConnection conn = new SqlConnection(SqlConnect);//创建数据库连接对象
            conn.Open();//打开数据库连接
        ...
        public static string GetSqlItem(string sql, string SqlConnect)
        {
            try
            {
                DataSet ds = GetSQL(sql, SqlConnect);
        ...
        public static DataSet GetSQL(string sql, string SqlConnect)
        {
            DataSet ds = new DataSet();
            SqlConnection myConnection = new SqlConnection(SqlConnect);
            myConnection.Open();
        ...
        public static int RunProc(string procName, SqlParameter[] prams, string connstr)
        {
        ...
        /// <param name="procName">存储过程的名字</param> 
        /// <param name="prams">存储过程的输入参数列表</param> 
        /// <returns>存储过程的返回结果集</returns> 
        public static DataSet RunProcDataSet(string procName, SqlParameter[] prams, string connstr)
        {
            SqlConnection conn = new SqlConnection(connstr);//创建数据库连接对象
        ...
        /// <param name="OutName">定义Output参数</param>
        /// <returns>返回值</returns>
        public static object ProcOutput(string procName, SqlParameter[] paras, string OutName)
        {
            SqlConnection conn = new SqlConnection(AppCommon.WCSConnstr);//创建数据库连接对象
            conn.Open();//打开数据库连接
