...
namespace RFIDApp2001
{
    public partial class Form1 : Form
    {
        ...
        string connstr = "Persist Security Info =true; Password=!Q@W#E$R5t6y7u8i;User ID = sa ; Initial Catalog = HGWCSB; Data Source =.";
        string sql1_select = "";
        string NPalletID = "";
        //string NPalletID_L = "";
        ...
        private void button5_Click(object sender, EventArgs e)
        {
            ...
            res = Reader.Net_EPC1G2_WriteWordBlock(m_hSocket, Convert.ToByte(EPC_Word), IDTemp, 1, Convert.ToByte(txtWStart.Text), Convert.ToByte(txtWLen.Text), mask, AccessPassWord);
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            //读EPC标签
            res = Reader.Net_EPC1G2_ReadLabelID(m_hSocket, mem, Convert.ToByte(txtRStart.Text), Convert.ToByte(txtRLen.Text), mask, IDBuffer, ref nCounter);
            if (res == OK)
            {
                //int kk = 0;
            ...
            if (comboBox3.Text != "")
            {
                ...
                //通过标签读取托盘号
                res = Reader.Net_EPC1G2_ReadWordBlock(m_hSocket, Convert.ToByte(EPC_Word), IDTemp, 1, Convert.ToByte(txtRStart.Text), Convert.ToByte(txtRLen.Text), DB, AccessPassWord);
                if (res == OK)
                {
                    str = "";
                    ...
                    if (this.txtInWareName.Text == "2019")
                    {
                        ...
                        SqlBase.ExecSql($"update RFID_Config set RPallet='{NPalletID}',RStatus=0,RTime=GETDATE() where ReaderIp='{this.textBox1.Text}'", connstr);
                    }
