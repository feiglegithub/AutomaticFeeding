...
namespace WCS
{
    public class OpcHs
    {
        ...
        //1楼出库站台写入任务
        public static void WriteStationOutTask_1(int stationNo, Wcs_Task taskInfo)
        {
            int cpuNo;
            int itemNo;
            if (stationNo < 5)
        ...
        public static bool WriteToMainpulator(int no, int fromStation, int toStation)
        {
            ...
            {
                //1号机械手
                Item item1 = OpcBaseManage.opcBase.GetItem(0, 290);
                item1.Write(fromStation);
                Item item2 = OpcBaseManage.opcBase.GetItem(0, 291);
                item2.Write(toStation);
            }

            WaitMBusy(no);

            return ReadMAcceptTask(no);
        }
        ...
        public static int JXSMsg(int i)
        {
            ...
            {
                case 1:  break;
                case 2:  item = OpcBaseManage.opcBase.GetItem(0, 2792); break;
            }
