...
{   
    public class Sql
    {
        #region BaseSql
        //获取10.30.3.116服务器的时间
        public static string GetServiceDateTime()
        {
            var ds = GetSQL2("select GetDate()");
        ...
        public static DataSet GetSQL2(string sql)
        {
            DataSet ds = new DataSet();
            SqlConnection myConnection = new SqlConnection(AppCommon.WCSConnstr2);
            myConnection.Open();
